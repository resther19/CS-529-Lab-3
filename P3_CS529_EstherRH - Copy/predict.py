...
fn2class = dict(zip(df.fname, df.genre))
...
y_true, y_pred, fn_prob = build_predictions('clean16k')
acc_score = accuracy_score(y_true=y_true, y_pred=y_pred)

#adds the probabilities for each class and the predicted class to the dataframe
y_probs = []
...
df.to_csv('predict_training.csv', index=False)
